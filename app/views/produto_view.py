...
class Produto_View:
    ...
    def preencher_campos(self, produto):
        ...
        for indice, fornecedor in enumerate(self._fornecedores): #Enumerate pega a posiçao do vetor e coloca no indice, e o "valor" vai pro fornecedor
            if fornecedor.id == produto.fornecedor.id:
                self.cmb_fornecedores.current(indice) # Aqui esta falando pra aparecer na tela o fornecedor que esta naquela indice
                break
